...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        make_option('--site',
                    ...
                    help="Use to specify the domain of the site you are importing redirects into. "
    ...
    def execute(self, *args, **options):
        ...
        if header_row != ["Old Url", "New Url", "Response Code"]:
            raise CommandError(
                "CSV file is missing the correct header row.  Should be Old Url, New Url and Response Code")
